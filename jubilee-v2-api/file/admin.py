...
from .services import FileStandardUploadService
...
class FileAdmin(SecureModelAdmin):
    list_display = [
        "id",
        "original_file_name",
        "file_name",
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj is not None:
            return ["original_file_name", "file_name", "file_type", "created_at", "updated_at", "upload_finished_at", "uploaded_by"]
...
# File model is not needed in Jubilee admin API
